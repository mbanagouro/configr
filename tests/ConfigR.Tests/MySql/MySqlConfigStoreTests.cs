...
[Collection("MySqlConfigStore")]
public sealed class MySqlConfigStoreTests
{
    private async Task<MySqlConfigStore> CreateStoreAsync()
    {
        ...
        return new MySqlConfigStore(options);
    }
