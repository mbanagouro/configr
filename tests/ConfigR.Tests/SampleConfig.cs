...
public sealed class SampleConfig
{
    ...
    public string? Name { get; set; } = "FromData";
    public DateTime CreatedAt { get; set; } = new DateTime(2024, 10, 1);
    public bool IsEnabled { get; set; } = false;
    public List<string> Tags { get; set; } = new() { "mock", "integration" };
    public NestedData Details { get; set; } = new NestedData { Level = 9, Description = "From Data" };
}
